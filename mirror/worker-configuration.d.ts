/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 39ac311943c185bb06fd26b2d9e7ba68)
// Runtime types generated with workerd@1.20260515.1 2026-01-09 nodejs_compat
interface __BaseEnv_Env {
	...
	PART_SIZE: "52428800";
	RETAIN_VERSIONS: "2";
	PMTILES_MIRROR: Workflow<Parameters<import("./src/index").PmtilesMirrorWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "UPSTREAM_BASE" | "MIRROR_PREFIX" | "PART_SIZE" | "RETAIN_VERSIONS">> {}
}
