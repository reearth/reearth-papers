/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ef37bf8839ee3e6cd3c4ad71165afc15)
// Runtime types generated with workerd@1.20260518.1 2026-01-09 
interface __BaseEnv_Env {
	R2: R2Bucket;
	DEFAULT_STYLE_URL: "https://reearth-papers-mirror.reearth.workers.dev/style.json";
	MIRROR_PREFIX: "mirror/protomaps";
	PAINT_STYLES_PREFIX: "styles";
	TILE_CONTAINER: DurableObjectNamespace<import("./src/index").TileRenderer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TileRenderer";
	}
